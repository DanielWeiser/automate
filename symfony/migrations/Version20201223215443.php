 ...
 */
final class Version20201223215443 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE orders (id INT AUTO_INCREMENT NOT NULL, contract_id INT NOT NULL, INDEX IDX_E52FFDEE2576E0FD (contract_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE orders_product (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, orders_id INT NOT NULL, quantity DOUBLE PRECISION NOT NULL, INDEX IDX_223F76D64584665A (product_id), INDEX IDX_223F76D6CFFE9AD6 (orders_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE orders ADD CONSTRAINT FK_E52FFDEE2576E0FD FOREIGN KEY (contract_id) REFERENCES contract (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE orders DROP FOREIGN KEY FK_E52FFDEE2576E0FD');
